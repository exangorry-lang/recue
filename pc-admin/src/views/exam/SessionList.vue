<template>
  <div class="card">
    <div class="page-title">考试场次管理</div>
    <div class="toolbar">
    ...
    <el-dialog v-model="dialog.visible" title="创建考试场次" width="520px">
      <el-form :model="dialog.form" label-width="100px">
        ...
        <el-form-item label="时长(分钟)">
          <el-input-number v-model="dialog.form.duration" :min="1" />
        </el-form-item>
        <el-form-item label="卷面总分">
          <el-input-number v-model="dialog.form.totalScore" :min="1" />
        </el-form-item>
        <el-form-item label="及格线">
          <el-input-number v-model="dialog.form.passScore" :min="1" />
        </el-form-item>
      </el-form>
      <template #footer>
...
import { getSessionList, createSession } from '@/api'
